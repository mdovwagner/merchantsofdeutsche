...
export function Edge(props) {
  ...
  return /*#__PURE__*/_jsxs("div", {
    ...
    children: [/*#__PURE__*/_jsx("svg", {
      width: Math.abs(x2 - x1) + 53,
      height: Math.abs(y2 - y1) + 43,
    ...
    }), numbers.map((n, i) => /*#__PURE__*/_jsx("div", {
      className: "RoadDive",
      style: {
        position: 'absolute',
        top: ys[n] - y1 + 23,
      ...
      onClick: event => {
        handleClick(event, props.edge, n);
      },
      children: /*#__PURE__*/_jsx(RoadHouse, {
        edge: props.edge,
        i: n,
        player: players[n],
    ...
    }, "n" + i)), numbers.map((n, i) => /*#__PURE__*/_jsx("div", {
      style: {
        position: 'absolute',
        top: ys[n] - y1 + 23,
        left: xs[n] - x1 + 33
